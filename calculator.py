...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value = ""
        Entry(width = 17, bg = "#87CEFA", font = ('Arial Bold', 28), textvariable = self.equation).place(x=0,y=0)
        ...
        Button(width = 11, height = 4, text = '=',relief = 'flat', bg = '#87CEFA', command = self.solve).place(x = 270, y = 350)
        Button(width = 11, height = 4, text = 'C',relief = 'flat', bg = '#FAA0A0', command = self.clear).place(x = 0, y = 350)
